...
PARAMETER_LOG_FILE_INT = str(
    ...
    / "results"
    / "logs"
    / "log_full_E2_int_fixed_system1.json"
)
...
SUBJECT_SUMMARY_FILE = str(
    ...
    / "tables"
    / "mental_models"
    / "mental_models_subject_summary_E2_2.csv"
)
...
TASK_SUMMARY_FILE = str(
    ...
    / "tables"
    / "mental_models"
    / "mental_models_task_summary_E2_2.csv"
)
...
POSTHOC_CACHE_FILE = str(
    ...
    / "data"
    / "cache"
    / "mental_models_posthoc_cache_E2_2.json"
)
...
def main():
    ...
    try:
        ...
        for subject_id, participant_trials in participant_iterator:
            ...
            # FORÇAGE DU SYSTÈME 1 ---
            # On force omega à 0.0 pour désactiver la recherche de 
            # modèles alternatifs (Système 2).
            for params in parameter_sets_int:
                params["sigma"] = 0.0
            
            # On met également à jour les paramètres sélectionnés pour 
            # que le CSV final reflète bien cette modification.
            selected_params_int["sigma"] = 0.0
