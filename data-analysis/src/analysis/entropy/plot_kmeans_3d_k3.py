...
# Dictionnaire des conclusions logiquement valides
VALID_CONCLUSIONS = {
...
def main():
    ...
    print("2. Application du K-Means (k=3)...")
    ...
    # Entraînement du K-Means pour 3 clusters
    ...
    # Palette de couleurs distinctes pour les 3 clusters (Vert, Orange, Rouge)
    ...
    ax.set_title('Clustering K-Means (k=3) : Les 3 Familles de Syllogismes', fontsize=15, fontweight='bold', pad=20)
