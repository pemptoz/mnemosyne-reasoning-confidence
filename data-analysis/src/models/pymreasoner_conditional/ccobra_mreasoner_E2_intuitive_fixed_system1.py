...
class CCobraMReasoner(ccobra.CCobraModel):
    ...
    def _create_parameter_values(self):
        ...
        # ---CONTRAINTE SYSTÈME 1 ---
        # On écrase la grille générée pour forcer sigma à 0.0
        values["sigma"] = np.array([0.0], dtype=np.float64)        # -------------------------------------------
    ...
    def _initialize_mreasoner(self):
        ...
        print("DEBUG: [ccobra] mReasoner initialisé.")
