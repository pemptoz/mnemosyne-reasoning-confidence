...
CCL_DIRECTORY = os.path.join(
    BASE_DIR,
    ".ccl",
)

MREASONER_SOURCE_DIRECTORY = os.path.join(
    BASE_DIR,
    ".mreasoner",
)
...
if __name__ == '__main__':
    ...
    # Les chemins relatifs sont interprétés depuis la racine du dépôt.
